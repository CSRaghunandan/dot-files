...
#+END_SRC
  ...
  + =Nord= themes for the following:
    ...
    + GTK theme using: =nordic= and use =gtk2= nordic theme for qt5 based
      applications
    ...
    + =bat= and =delta= in built Nord themes
    + Colored =man= pages using =bat=
    + =nano= UI Nord theme
    + =tmux= Nord theme using tpm plugin
    + =Xresources= Nord theme colors
    + =Zathura= UI Nord color theme
